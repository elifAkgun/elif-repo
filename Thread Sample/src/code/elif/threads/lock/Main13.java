package code.elif.threads.lock;
...
public class Main13 {
    ...
    private ReentrantReadWriteLock reentrantReadWriteLockForProduct = new ReentrantReadWriteLock();
    private Lock readLockForProduct = reentrantReadWriteLockForProduct.readLock();
    private Lock writeLockForProduct = reentrantReadWriteLockForProduct.writeLock();


    private ReentrantReadWriteLock reentrantReadWriteLockForProductReview = new ReentrantReadWriteLock();
    private Lock readLockForProductReview = reentrantReadWriteLockForProductReview.readLock();
    private Lock writeLockForProductReview = reentrantReadWriteLockForProductReview.writeLock();
    ...
    Lock getLockForAddProductReview() {
        // add code here
        return writeLockForProductReview;
    }

    Lock getLockForGetAllProductReviews() {
        return readLockForProductReview;
    }
